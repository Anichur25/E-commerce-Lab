...
Route :: get('/semester-result','MarksController@semester_result');
Route :: get('/individual-course-result','MarksController@individual_course_result');
Route :: get('/yearly-result','MarksController@yearly_result');
Route :: get('/individual-student-result','MarksController@individual_student_result');
Route :: get('/calculate-result','MarksController@calculate_result');
Route :: post('/show-semester-result','MarksController@show_semester_result');
Route :: post('/show-course-result','MarksController@show_course_result');
Route :: post('/show-yearly-result','MarksController@show_yearly_result');
route :: post('/show-individual-result','MarksController@show_individual_result');