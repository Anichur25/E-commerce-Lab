        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <div class="thumbnail">
                       <img src = "/images/somapuri.jpg"
                            class="card-img-top img-thumbnail myclass" alt="...">
                    </div>
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <div class="thumbnail">
                       <img src = "/images/shat_gombuj.jpg"
                            class="card-img-top img-thumbnail myclass" alt="...">
                    </div>
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <div class="thumbnail">
                            <img src = "/images/varindro_museum.jpg"
                            class="card-img-top img-thumbnail myclass" alt="...">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <div class="thumbnail">
                        <img src = "/images/natore_rajbari.jpg"
                            class="card-img-top img-thumbnail myclass" alt="...">
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.bangladesh.com/blog/explore-the-cultural-wonders-of-natore/" class="btn btn-primary" role = "button">See More...</a>
                    </div>
                </div>
            </div>
        </div>
