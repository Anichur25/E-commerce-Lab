...
Route :: get('/virtual-tour/{spot_id}','SpotController@virtual_tour');
Route :: get('/add-spot-virtual-tour','SpotController@add_virtual_tour');
Route :: post('/save-virtual-tour','SpotController@save_virtual_tour');